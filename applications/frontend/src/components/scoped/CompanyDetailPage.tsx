...
const SUBTITLE = 'Fiche entreprise avec la liste des collaborateurs rattachés et les actions de gestion.';
...
export function CompanyDetailPage({ scope, companyId }: CompanyDetailPageProps) {
    ...
    useBreadcrumbs(
        isAdmin
            ? company
                ? [{ label: 'Administration' }, { label: 'Entreprises', to: cfg.backTo }, { label: company.name }]
