...
/**
 * Détail entreprise côté coach. Réplique de `routes/admin/companies/$companyId.tsx` :
 * - liens vers `/coach/companies` au lieu de `/admin/companies` ;
 * - filtrage backend `useCompanies` retourne uniquement les entreprises ayant au moins
 *   une campagne du coach (cf. avancement-2026-04-28.md §1.b) ;
 * - actions destructives (suppression entreprise / participant) conservées par
 *   cohérence avec la décision V1.5 « permissions souples » — à durcir en V2 si besoin.
 */
            ...
            <Card variant="outlined">
                <CardContent sx={{ p: 4, textAlign: 'center' }}>
                    <Typography variant="h6" color="text.secondary">
                        Entreprise introuvable ou hors de votre périmètre.
                    </Typography>
                    <Button component={Link} to="/coach/companies" variant="outlined" sx={{ mt: 2, borderRadius: 3 }}>
            ...
            <Card variant="outlined">
                <CardContent sx={{ p: { xs: 2.5, md: 3 } }}>
                    ...
                    >
                        ...
                        <Button variant="outlined" component={Link} to="/coach/companies" sx={{ borderRadius: 3 }}>
                            Retour aux entreprises
                        </Button>
                    </Stack>
                </CardContent>
