        ...
        <Stack spacing={2}>
          ...
          <Box sx={{ borderRadius: 4, bgcolor: "rgba(15,23,42,0.03)", p: 1.5 }}>
            <Typography variant="body2" color="text.secondary" sx={{ lineHeight: 1.7 }}>
              {questionnaire.seriesLabels[0]} / {questionnaire.seriesLabels[1]} — {questionnaire.questionCountPerSeries} questions par série
            </Typography>
          </Box>
        </Stack>
      </CardContent>
        ...
        <Stack spacing={2.5}>
          ...
          <Card variant="outlined" sx={{ borderRadius: 6, borderColor: COLORS.border, boxShadow: "0 6px 18px rgba(15,23,42,0.04)" }}>
            <CardContent sx={{ p: 2.5 }}>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mt: 1.5, lineHeight: 1.8 }}>
                L’auto-évaluation et les pairs utilisent les short labels notés de 1 à 9. Ici, on bascule sur le test Élément Humain assigné par la campagne, sans option de sélection manuelle.
              </Typography>
            </CardContent>
          </Card>
        </Stack>
