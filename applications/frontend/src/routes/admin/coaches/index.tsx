    ...
    return (
        <Stack spacing={3}>
            ...
            <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "repeat(3, minmax(0, 1fr))" }, gap: 2 }}>
                <StatCard label="Coachs" value={coaches.length} helper="référencés" icon={UserRound} loading={isLoading} />
                <StatCard label="Actifs" value={activeCount} helper="en activité" icon={UserRound} loading={isLoading} />
                <StatCard label="Campagnes" value={campaigns.length} helper="attribuées" icon={ClipboardList} loading={campaignsLoading} />
            </Box>
                                      ...
                                      <CardContent sx={{ p: 2.5 }}>
                                          <Stack spacing={1.8}>
                                              ...
                                              <Box sx={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: 1.2 }}>
                                                  <MiniStat label="Campagnes" value={String(campaignCountByCoach.get(coach.id) ?? 0)} />
                                                  <MiniStat
                                                      label="Créé le"
